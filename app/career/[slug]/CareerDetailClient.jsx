...
export default function CareerDetailClient({ career }) {
  if (!career) {
    return (
      <main className="min-h-screen bg-slate-100 pt-32 pb-12">
        <div className="flex items-center justify-center">
          <article className="text-center max-w-md p-12 bg-white rounded-2xl shadow-lg border border-gray-200">
  ...
  return (
    <main className="min-h-screen bg-slate-100 pt-32 pb-16">
      <article className="max-w-4xl mx-auto mt-10 px-4 sm:px-6 lg:px-8">
        {/* Back Button */}
        ...
        <header className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 mb-8">
          ...
          <div className="text-center">
            <a
              href={`mailto:careers@capitalassociated.com?subject=Application for ${jobTitle}&body=Dear Hiring Team,%0A%0AI am interested in applying for the ${jobTitle} position.%0A%0APlease find my resume attached.%0A%0AThank you for your consideration.%0A%0ABest regards`}
        ...
        {/* Apply Again */}
        <section className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 text-center">
