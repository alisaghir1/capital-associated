...
const EditService = ({ params }) => {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === 'title') {
      ...
      reader.readAsDataURL(file);
    } else if (name.startsWith('gallery_file_')) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Add timeout protection for large image updates
      ...
      const timeoutPromise = new Promise((_, reject) => 
        setTimeout(() => reject(new Error('Request timeout - please try reducing image sizes')), 15000)
      );
      ...
      if (error) {
        ...
        throw new Error(error.message || error.details || 'Database update failed. Please check the data and try again.');
      }
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    <RichTextEditor
                      label="Title *"
                      description="The main title of your service"
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="text-lg font-medium text-gray-800">
                      Features <span className="text-gray-500 font-normal text-sm">(Key features or benefits of this service)</span>
                    </h3>
                    <button
                      type="button"
                      onClick={addFeature}
