        ...
        <div className="relative h-[30rem] w-full">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center w-full h-full">
            ...
            <p className="xl:text-4xl text-black md:text-2xl lg:text-3xl text-xl mt-5">
              Luxury Fit-Out Solutions in Dubai
            </p>
      ...
      <div className="bg-slate-100">
        <div className="container px-5 mx-auto flex flex-col items-center justify-center text-center gap-5 pt-20 pb-20">
          <h1 className="xl:text-3xl text-2xl text-center border-b border-b-black w-full pb-10">
            Contact Us for Interior Fit-Out Services in Dubai
          </h1>
          <p className="mb-4">
            Looking to enhance your interior with precision and style? Our
            expert interior fit-out services in Dubai are personalized to
            deliver exceptional spaces that fit with your vision, functionality,
            and brand identity.
          </p>
          <p className="mb-4">
            At Capital Associated Building Contracting, we specialize in bespoke
            interior fit-outs for residential, commercial, and hospitality
            projects. From space planning and material selection to flawless
            finishing, our team ensures every detail is executed to
            perfection—on time and within budget.
          </p>
          <p className="mb-4">
            Reach out today to schedule a consultation and discover how our
            turnkey fit-out solutions can bring sophistication, comfort, and
