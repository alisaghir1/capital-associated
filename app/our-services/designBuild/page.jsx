    ...
    <div>
      <div className="bg-white">
        ...
        <div className="container mx-auto flex flex-col gap-5 text-center px-4">
          ...
          <p className="mt-4">
            Desgin Build refers to the process of enhancing the interior
          ...
          <p className="mt-4">
            The goal of an Desgin Build is to create a harmonious and
          ...
          <p className="mt-4">
            ...
            providing transformative Desgin Build services that breathe new
          ...
          <div className="flex flex-col text-start justify-center mt-10">
            ...
            <div className="flex flex-col text-start justify-center mt-10">
              ...
              <p className="mb-4">
                The final step of our Desgin Build service involves adding
