    ...
    <div>
      <div className="bg-white">
        ...
        <div className="container mx-auto flex flex-col gap-5 text-center px-4">
          ...
          <p className="mt-4">
            Pre-Construction Services refers to the process of enhancing the interior
          ...
          <p className="mt-4">
            The goal of an Pre-Construction Services is to create a harmonious and
          ...
          <p className="mt-4">
            ...
            providing transformative Pre-Construction Services services that breathe new
          ...
          <div className="flex flex-col text-start justify-center mt-10">
            ...
            <div className="flex flex-col text-start justify-center mt-10">
              ...
              <p className="mb-4">
                The final step of our Pre-Construction Services service involves adding
      ...
      <div className="bg-slate-100">
        <div className="container mx-auto flex flex-col items-center justify-center text-center gap-5 pt-20 pb-20">
          ...
          <p className="mb-4">
            Ready to transform your space with our exceptional Pre-Construction Services
            services?
          </p>
          <p className="mb-4">
